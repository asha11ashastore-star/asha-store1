    ...
    <div className="min-h-screen bg-warm-white">
      ...
      <div className="bg-gradient-to-r from-brown-800 to-brown-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-24">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-elegant mb-4 sm:mb-6 tracking-wide text-white">
              About Aशा
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-cream max-w-3xl mx-auto leading-relaxed px-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mb-12 sm:mb-16 md:mb-20">
          <div>
            <h2 className="text-2xl sm:text-3xl font-elegant text-primary-900 mb-4 sm:mb-6 tracking-wide">Our Story</h2>
            <div className="space-y-4 sm:space-y-6 text-primary-700 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 mb-12 sm:mb-16 md:mb-20">
          <div className="bg-cream p-6 sm:p-8 rounded-lg">
            <h3 className="text-xl sm:text-2xl font-semibold text-primary-900 mb-3 sm:mb-4">Our Mission</h3>
          ...
          <div className="bg-cream p-6 sm:p-8 rounded-lg">
            <h3 className="text-xl sm:text-2xl font-semibold text-primary-900 mb-3 sm:mb-4">Our Vision</h3>
            <p className="text-primary-700 leading-relaxed">
        ...
        <div className="mb-12 sm:mb-16 md:mb-20">
          <h2 className="text-2xl sm:text-3xl font-elegant text-primary-900 mb-8 sm:mb-12 text-center tracking-wide">Our Values</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg sm:text-xl font-semibold text-primary-900 mb-2 sm:mb-3">Authenticity</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg sm:text-xl font-semibold text-primary-900 mb-2 sm:mb-3">Community</h4>
              <p className="text-sm sm:text-base text-primary-600">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg sm:text-xl font-semibold text-primary-900 mb-2 sm:mb-3">Sustainability</h4>
              <p className="text-sm sm:text-base text-primary-600">
        ...
        {/* Meet the Founder */}
        <div className="bg-gradient-to-r from-cream to-beige-100 rounded-lg p-6 sm:p-8 md:p-12 mb-12 sm:mb-16 md:mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-center">
            <div className="lg:col-span-2">
              <h2 className="text-2xl sm:text-3xl font-elegant text-primary-900 mb-4 sm:mb-6 tracking-wide">Meet Our Founder</h2>
              <h3 className="text-xl sm:text-2xl font-semibold text-maroon mb-3 sm:mb-4">Asha Dhaundiyal</h3>
              <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-primary-700 leading-relaxed">
                <p>
        ...
        {/* Our Impact */}
        <div className="mb-12 sm:mb-16 md:mb-20">
          <h2 className="text-2xl sm:text-3xl font-elegant text-primary-900 mb-8 sm:mb-12 text-center tracking-wide">Our Impact</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-center">
            <div>
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-maroon mb-1 sm:mb-2">{companyInfo.artisans_supported}</div>
              <div className="text-xs sm:text-sm md:text-base text-primary-700 font-medium">Artisans Supported</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-maroon mb-1 sm:mb-2">{companyInfo.villages_reached}</div>
              <div className="text-xs sm:text-sm md:text-base text-primary-700 font-medium">Villages Reached</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-maroon mb-1 sm:mb-2">{companyInfo.happy_customers}</div>
              <div className="text-xs sm:text-sm md:text-base text-primary-700 font-medium">Happy Customers</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-maroon mb-1 sm:mb-2">{companyInfo.years_of_excellence}</div>
              <div className="text-xs sm:text-sm md:text-base text-primary-700 font-medium">Years of Excellence</div>
            </div>
          </div>
        </div>

        {/* Why Choose Us */}
        <div className="bg-primary-900 text-white rounded-lg p-6 sm:p-8 md:p-12 mb-12 sm:mb-16 md:mb-20">
          <h2 className="text-2xl sm:text-3xl font-elegant mb-6 sm:mb-8 text-center tracking-wide">Why Choose Aशा?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {companyInfo.features.map((feature, index) => (
              <div key={index} className="text-center">
                ...
                <p className="text-beige-200 text-xs sm:text-sm">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center px-2">
          <h2 className="text-2xl sm:text-3xl font-elegant text-primary-900 mb-4 sm:mb-6 tracking-wide">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 items-center justify-center">
            <Link 
              href="/collections" 
              className="w-full sm:w-auto inline-block bg-maroon text-white px-8 sm:px-10 py-3 sm:py-4 rounded-lg font-medium hover:bg-dark-maroon transition-colors text-center sm:min-w-[250px]"
            >
              Shop Our Collection
            </Link>
            <Link 
              href="/contact" 
              className="w-full sm:w-auto inline-block bg-transparent border-2 border-maroon text-maroon px-8 sm:px-10 py-3 sm:py-4 rounded-lg font-medium hover:bg-maroon hover:text-white transition-colors text-center sm:min-w-[250px]"
            >
              Contact Us
            </Link>
          </div>
